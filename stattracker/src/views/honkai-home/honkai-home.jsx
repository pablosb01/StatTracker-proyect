  ...
  return (
    <>
      <div className="flex 2xl:flex-row flex-col md:justify-center md:items-center">
        ...
        />
        <div className="2xl:relative max-w-[800px] 2xl:w-1/2  flex flex-col z-20 gap-10 mt-10 xl:px-20 md:justify-center md:items-center">
          <img className="md:w-3/4 " src={HonkaiLogo} />
          <UserFormHonkai />
          <HonkaiButton />
        </div>
        <div className="xl:max-w-[600px] max-h-[800px] flex flex-col w-full z-20 xl:w-1/2 md:w-1/2 gap-16 items-center 2xl:mx-40 overflow-y: auto md:justify-center md:align-middle">
        <HonkaiCharacters />
        </div>
      </div>
    </>
