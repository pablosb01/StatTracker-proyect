...
export function ValoAgent(){
    ...
    return(
        <>
        <div className='flex-row w-full hidden xl:flex'>
            ...
            <div className='mx-auto p-5 w-3/5'>
                ...
                <div className='border-white-600 border-2 p-10 [clip-path:_polygon(20%_0,_100%_0,_100%_80%,_80%_100%,0_100%,_0_20%)]'>
        ...
        <div className='flex xl:hidden justify-between items-center flex-row gap-2 p-4 py-6'>
            ...
            <span className='flex flex-col justify-between items-center border-red-600 border-2 p-1 md:p-4 [clip-path:_polygon(20%_0,_100%_0,_100%_80%,_80%_100%,0_100%,_0_20%)]'>
