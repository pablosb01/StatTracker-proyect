...
export function Navbar() {
  ...
  const handleLanguageChange = (language) => {
    ...
    localStorage.setItemh("language", language);
  };
  ...
  return (
    <nav className="w-full flex justify-between bg-stone-900 px-5 sticky top-0 z-50">
      ...
      <div className="flex items-center justify-center">
        <button
          className="flex flex-row text-white items-center active:text-red-600 active:bg-stone-800 rounded-md px-3"
          onClick={() => SetIsOpen(!isOpen)}
        >
          Idiomas
          {isOpen ? (
            <MdOutlineArrowDropDown className='className="h-3.5' />
          ) : (
            <MdOutlineArrowDropUp className="h-3.5" />
          )}
        </button>
        {isOpen && (
          <div className="absolute top-[60px] bg-stone-800 rounded-lg items-center justify-center border border-3 p-3 ">
            <ul>
              <li>
                <button>
                  <svg
