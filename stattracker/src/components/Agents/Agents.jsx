    ...
    <div className="caja w-full max-w-[600px] h-[380px] rounded-[7px] overflow-hidden bg-gray-300">
      ...
      <div className="h-[332px] overflow-y-auto">
        {agentsData.map((agent, index) => (
          <div className="group bg-gray-300 hover:bg-gray-400 flex px-3 py-2 justify-between border-b border-stone-800 transition-all duration-300 ease-in-out" key={index}>
