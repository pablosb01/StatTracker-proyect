  ...
  return (
    <div className="flex justify-end overflow-visible">
      ...
      <div className="grid grid-cols-3 gap-0.5 p-0.5 sm:min-w-[40%] md:min-w-[50%] lg:min-w-[60%] text-center transition-all ease-in-out duration-500">
        <div className="flex  flex-row justify-center items-center  text-white font-bold bg-gray-300/10 rounded-[2rem]">
          <img
        ...
        <div className="flex col-span-2 justify-center items-center text-white px-2 bg-gray-300/10 rounded-[2rem]">
          <p>{obj.attributes[0].value.toFixed(2)}</p>
        </div>
        <div className="flex justify-center items-center text-white font-bold bg-gray-300/5 rounded-[2rem]">
          <img
        ...
        <div className="flex col-span-2 justify-center items-center text-white px-2 bg-gray-300/5 rounded-[2rem]">
          <p>{obj.attributes[1].value.toFixed(2)}</p>
        </div>
        <div className="flex justify-center items-center text-white font-bold bg-gray-300/10 rounded-[2rem]">
          <img
