...
export default function BoxHUC ({children, stl, title}) {
    return (
      <div className={`rounded-2xl z-50 ${stl}`}>
        <div className="flex items-center h-5 sm:h-8 md:h-10 lg:h-12 rounded-2xl drop-shadow-md group bg-gradient-to-r from-black to-[#42A3AD] border border-gray-300 hover:from-[#42A3AD] hover:to-black">
