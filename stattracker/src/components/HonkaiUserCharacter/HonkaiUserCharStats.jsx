...
export default function HonkaiUserCharStats({ obj }) {
  ...
  return (
    <div className="grid grid-cols-3 w-full h-[90%] sm:h-[91%] md:h-[88%] lg:h-[85%] gap-0.5 p-0.5 z-10 text-center transition-all ease-in-out duration-500">
      <div className="col-span-2 flex justify-center items-center text-white font-bold bg-gray-300/10 rounded-2xl z-10">
        <p>{statsObj.hp.name}</p>
      </div>
      <div className="flex justify-center items-center text-white bg-gray-300/10 rounded-2xl z-10">
        <p>{statsObj.hp.value.toFixed(2)}</p>
      </div>
      <div className="col-span-2 flex justify-center items-center text-white font-bold bg-gray-300/5 rounded-2xl z-10">
        <p>{statsObj.atk.name}</p>
      </div>
      <div className="flex justify-center items-center text-white bg-gray-300/5 rounded-2xl z-10">
