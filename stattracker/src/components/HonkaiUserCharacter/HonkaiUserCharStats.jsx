...
export default function HonkaiUserCharStats({ obj }) {
  ...
  return (
    <div className="grid grid-cols-2 w-full gap-0.5 p-0.5 z-10">
      <div className="flex justify-center text-white font-bold bg-gray-300/10 rounded-2xl z-10">
        <p>{statsObj.hp.name}</p>
      </div>
      <div className="flex justify-center text-white bg-gray-300/10 rounded-2xl z-10">
        <p>{statsObj.hp.value.toFixed(2)}</p>
      </div>
      <div className="flex justify-center text-white font-bold bg-gray-300/5 rounded-2xl z-10">
        <p>{statsObj.atk.name}</p>
      </div>
      <div className="flex justify-center text-white bg-gray-300/5 rounded-2xl z-10">
