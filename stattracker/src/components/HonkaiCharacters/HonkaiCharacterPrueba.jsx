export function HonkaiCharacterPrueba({ character, index }) {
  return (
    ...
    >
      <img
        className="mb-1 rounded-xl relative w-max z-0 top-[3rem] scale-[125%] group-hover:scale-[145%] transition-all ease-in-out duration-500"
      ...
      />
      <div className="min-h-[40px] flex justify-center items-end pb-2 bg-gradient-to-t from-black/35 group-hover:from-black/50 z-50 rounded-b-xl ">
