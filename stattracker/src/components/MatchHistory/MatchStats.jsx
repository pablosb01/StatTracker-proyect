...
export function MatchStats({playerid}) {
  ...
  useEffect(() => {
    ...
    return (
      <>
        <div className="group bg-gray-300 hover:bg-gray-400 lg:flex items-center h-auto md:p-3 hidden border-b border-stone-800 transition-all duration-700 ease-in-out">
