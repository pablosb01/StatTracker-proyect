...
export function MatchStats({playerid}) {
  ...
  useEffect(() => {
    ...
    return (
      <>
        <div className="group bg-gray-300 hover:bg-gray-400 lg:flex items-center flex  h-auto md:p-3 hidden border-b border-stone-800 transition-all duration-300 ease-in-out">
